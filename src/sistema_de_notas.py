...
from src.exceptions import NotaInvalidaError, NotaDuplicadaError
...
class SistemaDeNotas:
    ...
    def registrar_nota(self, estudiante: str, materia: str, semestre: str, nota: float) -> None:
        ...
        if semestre in self.notas[estudiante][materia]:
            raise NotaDuplicadaError(f"Ya existe una nota registrada para {materia} en el semestre {semestre}")
